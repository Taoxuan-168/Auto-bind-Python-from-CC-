...
build_time_vars = {
    ...
    'CONFIG_ARGS': "'--enable-optimizations' '--prefix=/usr/local' '--enable-shared'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Python-3.13.2/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Python-3.13.2/lcov-report',
    ...
    'LIBPL': '/usr/local/lib/python3.13/config-3.13-aarch64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/Python-3.13.2 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/Python-3.13.2 ./python -E -m test',
    ...
    'abs_builddir': '/Python-3.13.2',
    'abs_srcdir': '/Python-3.13.2',
